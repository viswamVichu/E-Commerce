    ...
    <>
      <footer className='p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800'>
        <div className='mx-auto max-w-screen-xl text-center'>
          <a
            href='#'
            className='flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white font-[Roboto]'
          >
            <svg
              className='mr-2 h-8 '
              viewBox='0 0 33 33'
          ...
          <p className='my-6 font-[Roboto] text-gray-500 dark:text-gray-400'>
          ...
          <ul className='flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white'>
            <li>
              <a
                href='#'
                className='mr-4 font-[Roboto] hover:underline md:mr-6 '
              >
                About
              </a>
            </li>
          ...
          <span className='text-sm text-gray-500 font-[Roboto] sm:text-center dark:text-gray-400'>
            © 2021-2022{" "}
